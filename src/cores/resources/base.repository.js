...
export default class BaseRepository {
  ...
  count(where, options = {}) {
    return this._model
      ...
      .count(extend(options, { where: where }))
      .bind({ self: this })
  }
  max(column, where, options = {}) {
    return this._model
      .scope(options.scope || null)
      .max(column, extend(options, { where: where }))
      .bind({ self: this })
  ...
  findOne(where, options = {}) {
    return this._model
      .scope(options.scope || null)
      .findOne(extend(options, { where: where }))
      .bind({ self: this })
      .then(function(result) {
        return this.self.__toObject(result)
      })
  ...
  findBy(where, options = {}) {
    return this._model
      .scope(options.scope || null)
      .findAll(extend(options, { where: where }))
      .bind({ self: this })
      .then(function(result) {
        return this.self.__toObject(result)
      })
  ...
  findAndCountAllBy(where, options = {}) {
    return this._model
      .scope(options.scope || null)
      .findAndCountAll(extend(options, { where: where }))
      .bind({ self: this })
      .then(function(result) {
  ...
  findOrCreate(where, defaultValues, options = {}) {
    return this._model
      .findCreateFind(extend(options, { where: where, defaults: defaultValues }))
      .bind({ self: this })
      .then(function(result) {
        result.rows = this.self.__toObject(result.rows)
        return result
